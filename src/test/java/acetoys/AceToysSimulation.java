...
public class AceToysSimulation extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("AceToysSimulation")
    ...
    .exec(Category.allCategoriesAllProducts)
    .pause(2)
    .exec(Category.allCategoriesFirstPage)
    .pause(2)
    .exec(Category.getAllCategoriesSecondPage)
    .pause(2)
    .exec(Category.getAllCategoriesThirdPage)
    .pause(2)
    .exec(Product.productPage)
    .pause(2)
    .exec(Product.addProductCart)
    .pause(2)
    .exec(Product.addProductCart)
    .pause(2)
    .exec(Product.addProductCart)
    ...
    .pause(2)
    .exec(Cart.increaseCartQuantity20)
    .pause(2)
    .exec(Cart.increaseCartQuantity20)
    .pause(2)
    .exec(Cart.increaseCartQuantity20)
    .pause(2)
    .exec(Cart.increaseCartQuantity13)
    .pause(2)
    .exec(Cart.decreaseCartQuantity20)
          .exec(Cart.cartOverviewPage)
          .pause(2)
    .pause(2)
